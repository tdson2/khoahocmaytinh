...
Mỗi tài liệu có: ý tưởng, giải thích, ví dụ, công thức/mã giải, độ phức tạp và code mẫu (Python/C++) khi phù hợp. **Ứng dụng thực tế** (ví dụ dễ hiểu) của từng phương pháp/thuật toán/mô hình nằm ở **phần giới thiệu mở đầu** của từng tài liệu tương ứng.
