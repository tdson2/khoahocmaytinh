...
**Ứng dụng thực tế:** Thứ tự build/compile (dependency); lập lịch công việc có phụ thuộc; thứ tự thực thi task trong pipeline; xử lý prerequisite trong khóa học.
